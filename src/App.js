        ...
        return (
            <AppContainer>
                <StyledContainer>
                    <StyledFilter>
                        <ul>
                            <li onClick={()=> setSortBy({attr:"name", type:"string"})}><p>Sort <b>alphabetically</b></p></li>
                            <li onClick={() => setSortBy({attr:"price", type:"number"})}><p>Sort by <b>price</b></p></li>
                            <li onClick={() => setSortBy({attr:"rating", type:"number"})}><p>Sort by <b>star rating</b></p></li>
                        </ul>
                    </StyledFilter>
                    <div className="app">
                        {hotelList.map(hotel => (<Hotel key={hotel.id } {...hotel}/>)
                        )}
                    </div>
                </StyledContainer>
            </AppContainer>
